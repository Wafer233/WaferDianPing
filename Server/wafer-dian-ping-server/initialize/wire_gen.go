...
func Init() (*gin.Engine, error) {
	...
	likeRepository := cache.NewLikeRepository(client)
	likeService := application.NewLikeService(likeRepository)
	blogService := application.NewBlogService(blogRepository, userService, likeService)
